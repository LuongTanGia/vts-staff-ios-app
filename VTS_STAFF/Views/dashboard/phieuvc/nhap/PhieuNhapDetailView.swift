...
struct PhieuNhapDetailView: View {
    private enum Strings {
        ...
        static let titleEdit = "Cập nhật chuyến hàng nhận"
        ...
        static let fieldHangNhan = "Hàng nhận"
        ...
        static let galleryItem1 = "Ảnh 1 - Phiếu nhập 1"
        static let galleryItem2 = "Ảnh 2 - Phiếu nhập 2"
