...
enum QueryType: String, CaseIterable, Identifiable {
    case byItem = "Hàng hóa"
    case byCus = "Khách hàng"
    
    var id: String { self.rawValue }
}

@MainActor
final class TruyVanNhapViewModel: ObservableObject {
    ...
    func loadData(for type: QueryType) async {
        ...
        do {
            ...
            if isItem {
                response = try await TruyVanService.shared.hangNhap_ByItem(
